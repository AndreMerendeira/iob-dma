...
set_global_assignment -name PARTITION_NETLIST_TYPE POST_SYNTH -section_id "iob_dma:iob_dma_0"

set_global_assignment -name PARTITION_FITTER_PRESERVATION_LEVEL PLACEMENT_AND_ROUTING -section_id "iob_dma:iob_dma_0"

set_global_assignment -name PARTITION_COLOR 39423 -section_id "iob_dma:iob_dma_0"
